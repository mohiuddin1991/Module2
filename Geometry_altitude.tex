...
\item Find the equations of the altitudes $BE_1$ and $CF_1$ to the sides $AC$ and $AB$ respectively. 
 ...
 \end{align}
  ...
  \begin{figure}[H]
      \centering
      \includegraphics{line_be_cf.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{intersect_H.png}
...
=0
\end{align}
see \figref{fig:Plot_ABCH}
\begin{figure}
    \centering
    \includegraphics{Plot_ABCH.png}
